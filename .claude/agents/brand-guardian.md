...
## Loupe: The Brand You're Guarding

**Product**: Correlation layer between page changes and business outcomes. We track what changes on your site and show you whether it helped or hurt.

**The core insight**: The value isn't catching changes fast (that's VisualPing). It's understanding what caused what — a week later, a month later. "Your headline changed Jan 28. Since then, bounce rate is up 12%."

**The "Only" statement**: We are the only tool that connects your page changes to your actual metrics — so you know what's working and what isn't.

**ICP (Two segments)**:
1. **Vibe coders** — Non-technical founders using AI-first tools (Lovable, Bolt, Base44). No version control mental model. Most vulnerable to changes, least equipped to notice them.
2. **Technical solo founders** — Developers shipping fast ($500-$10k MRR). Could build this themselves but won't maintain it. Too busy with features to watch the marketing layer.

**Their internal monologue**: "Conversions dropped but I don't know what changed." "Wait, where did my pricing section go?" "My friend said my site looks different... I didn't change anything."

**Competitive alternatives**: Check manually (never happens), visual regression tools (catch pixels, not meaning), change monitoring (VisualPing tells you *something* changed, not *what* it means), DIY Playwright (will break in 3 months).

**Archetype**: Sage/Creator (Notion, Linear energy). The observant friend who notices what you missed.

**Voice**: Direct, confident, no-nonsense. Technical but not jargony. Human but not warm — straight to the point with quiet competence.

**We say**: "When metrics move, know why", "Did that change work?", "See what changed. See what it did.", "Here's what we expect if you fix it", direct observations backed by data.

**We never say**: "Catch drift" (sounds like VisualPing), "Your score is..." (we don't grade), "AI-powered" (meaningless), "Monitor your site" (too generic), vague promises, startup bro energy ("crush it", "10x"), emojis.
